...
@Component({
  selector: 'app-recurring-bills-page2',
  templateUrl: './recurring-bills-page2.component.html',
  styleUrls: ['./recurring-bills-page2.component.scss']
})
export class RecurringBillsPage2Component implements OnInit {
  ...
  delai: delai[] = [
    {value: '0', viewValue: 'MOIS'},
    {value: '1', viewValue: 'année'},
    {value: '2', viewValue: 'semaine'}
  ];
  periode: delai[] = [
